  ...
  return (
    <Stack
      ...
      <Typography variant="body1" gutterBottom>
        Developed for Lockheed Martin, this responsive web application used to manage and showcase
        the workflow of maintenance requests for products, typically software licenses. Owners of
        ...
        is provided to each request. These users may be able to track and approve payments. Reports
